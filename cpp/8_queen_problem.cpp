 ...
 * grid[][] is represent the 2-d array with value(0 and 1) 
 * for grid[i][j]=1 means queen i are placed at j column.
 * we can take any number of queen, for this time we take 
 * the atmost 10 queen (grid[10][10]).
 */
#include<iostream>
using namespace std;
